            ...
            <div className="flex justify-center items-center min-h-screen bg-gray-900">
                <div className={`relative w-[350px] h-[500px] transition-transform duration-1000`}>
                    ...
                    >
                        ...
                        <input type="email" placeholder="email" className="w-60 h-11 px-3 rounded-md border-2 border-[#212121] bg-[#212121] text-white shadow-[6px_6px_10px_rgba(0,0,0,1),1px_1px_10px_rgba(255,255,255,0.6)] focus:scale-105 focus:outline-none transition-all duration-300" />
                        <div className="relative w-60">
                            <input type={showPassword ? 'text' : 'password'} placeholder="Password" className="w-full h-11 px-3 pr-10 rounded-md border-2 border-[#212121] bg-[#212121] text-white shadow-[6px_6px_10px_rgba(0,0,0,1),1px_1px_10px_rgba(255,255,255,0.6)] focus:scale-105 focus:outline-none transition-all duration-300" />
